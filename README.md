...
I co-developed [Patternite](https://patternite.com), a tool for crowd-sourced software design patterns, along with [jonparkdev](https://github.com/jonparkdev). Everyone is welcome to contribute, and you can read more about Patternite [here](https://patternite.com/about). I also wrote an article for Hacker Noon about Patternite's development, which you can read [here](https://hackernoon.com/how-we-built-this-a-platform-for-crowdsourced-design-patterns-kj1j33j9). Below is a badge showing my contributions.
